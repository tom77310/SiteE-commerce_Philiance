...
function TousLesAvis(): array {
    ...
    try {
        ...
        // Hydratation automatique dans la classe Avis
...
function AjoutAvis(
    ...
    $sqlReq = "INSERT INTO avis 
               (id_utilisateur, id_produit, note, commentaire)
               VALUES(:utilisateur, :produit, :note, :commentaire)";
...
// Fonction pour verifier si un avis existe deja
// Empêche plusieurs avis d'un même utilisateur sur le même produit
...
// Avoir les avis d'un utilisateur
