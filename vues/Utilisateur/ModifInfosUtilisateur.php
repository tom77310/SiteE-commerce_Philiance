<?php
$titre = "UrbanStyle: Utilisateur - Modifier mes informations Persos";
ob_start();
    ...
    <div class="col-md-8 mx-auto">
        ...
        <div class="card shadow">
            <div class="card-body p-4">
                ...
                <h2 class="text-center text-decoration-underline mt-3 mb-4">Modifier mes informations</h2>

                <form method="post" action="index.php?action=utilisateur_modifier_compte_traitement">
