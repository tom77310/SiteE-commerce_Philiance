<?php
$titre = "UrbanStyle: Utilisateur - Mes Avis";
ob_start();
?>

<h1 class="mb-4 text-center text-decoration-underline mt-3">Mes Avis</h1>
                ...
                <tbody>
                    <?php foreach ($avis as $a) { ?>
                        <tr>
                            ...
                            <td class="p-3">
                                <a href="index.php?action=Avis_modifieravis&id=<?= $a['id_avis'] ?>&retour=mes_avis"
                                    class="btn btn-sm btn-warning">
                                    Modifier l'avis
                                </a>
                            </td>
                            <td class="p-3">
                                <a href="index.php?action=Avis_supprimeravis&id=<?= $a['id_avis'] ?>&retour=mes_avis"
