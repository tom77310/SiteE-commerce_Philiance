<?php
$titre = "UrbanStyle : Administrateur - Gestion des Commandes";
ob_start();

/** @var Commande $commandes */ // Evite l'erreur visuel de VSCode sur les variables
?>

<h1 class="text-center text-decoration-underline mt-3 mb-4">Gestion des commandes </h1>
            ...
            <tbody>
                <?php foreach($commandes as $commande){ ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?action=Commande_recap&id=<?= $commande['id_commande'] ?>&source=admin" class="btn btn-sm btn-primary">
                                Voir
                            </a>
