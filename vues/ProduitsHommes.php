<?php
$titre = "Site e-commerce 2022-2023 : Articles Enfants";
ob_start();

/**
 * @var array $produitHommes
...
<div class="container mt-4">
    <div class="row">
        ...
        <?php foreach ($produitHommes as $p) : ?>
            ...
            <?php /** @var Produit $p */ // Enlève l'erreur visuel de VSCode des variables ?> 
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <h5 class="card-title">
                            <?= htmlspecialchars($p->getNomProduit()) ?>
                        </h5>

                        <h5 class="card-title">
                            <?= htmlspecialchars($p->getTaille()) ?>
                        </h5>
